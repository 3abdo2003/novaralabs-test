...
const InventoryPage: React.FC = () => {
  ...
  return (
    <div className="p-4 sm:p-8 pb-20 max-w-[1600px] mx-auto relative">
      ...
      {isAdding && (
        <div className="fixed inset-0 bg-zinc-900/40 backdrop-blur-sm z-50 flex items-center justify-center p-4 sm:p-6 transition-all duration-300">
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[85dvh] sm:max-h-[90vh] shadow-2xl overflow-hidden border border-zinc-100 relative animate-in fade-in zoom-in-95 duration-200 flex flex-col">
            ...
            <form id="inventory-form" onSubmit={handleSubmit} className="flex-1 flex flex-col min-h-0 bg-zinc-50/50">
              <div className="p-3 sm:p-8 space-y-3 sm:space-y-6 flex-1 overflow-y-auto overscroll-contain custom-scrollbar">
